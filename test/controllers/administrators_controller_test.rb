...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { created_at: @administrator.created_at, email: @administrator.email, lastname: @administrator.lastname, name: @administrator.name, user: @administrator.user } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { created_at: @administrator.created_at, email: @administrator.email, lastname: @administrator.lastname, name: @administrator.name, user: @administrator.user } }
